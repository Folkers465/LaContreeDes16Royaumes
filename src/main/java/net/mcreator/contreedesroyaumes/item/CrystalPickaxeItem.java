...
public class CrystalPickaxeItem extends ContreeDesRoyaumesModElements.ModElement {
	@ObjectHolder("contree_des_royaumes:crystal_pickaxe")
	public static final Item block = null;
	public CrystalPickaxeItem(ContreeDesRoyaumesModElements instance) {
		super(instance, 91);
	}
