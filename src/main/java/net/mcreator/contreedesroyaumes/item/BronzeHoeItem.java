...
public class BronzeHoeItem extends ContreeDesRoyaumesModElements.ModElement {
	@ObjectHolder("contree_des_royaumes:bronze_hoe")
	public static final Item block = null;
	public BronzeHoeItem(ContreeDesRoyaumesModElements instance) {
		super(instance, 11);
	}
