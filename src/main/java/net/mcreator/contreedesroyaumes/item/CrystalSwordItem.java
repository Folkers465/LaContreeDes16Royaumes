...
public class CrystalSwordItem extends ContreeDesRoyaumesModElements.ModElement {
	@ObjectHolder("contree_des_royaumes:crystal_sword")
	public static final Item block = null;
	public CrystalSwordItem(ContreeDesRoyaumesModElements instance) {
		super(instance, 93);
	}
