...
public class VibraniumShovelItem extends ContreeDesRoyaumesModElements.ModElement {
	@ObjectHolder("contree_des_royaumes:vibranium_shovel")
	public static final Item block = null;
	public VibraniumShovelItem(ContreeDesRoyaumesModElements instance) {
		super(instance, 31);
	}
