...
public class RubisHoeItem extends ContreeDesRoyaumesModElements.ModElement {
	@ObjectHolder("contree_des_royaumes:rubis_hoe")
	public static final Item block = null;
	public RubisHoeItem(ContreeDesRoyaumesModElements instance) {
		super(instance, 53);
	}
