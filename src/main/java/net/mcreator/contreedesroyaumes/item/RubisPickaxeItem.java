...
public class RubisPickaxeItem extends ContreeDesRoyaumesModElements.ModElement {
	@ObjectHolder("contree_des_royaumes:rubis_pickaxe")
	public static final Item block = null;
	public RubisPickaxeItem(ContreeDesRoyaumesModElements instance) {
		super(instance, 49);
	}
