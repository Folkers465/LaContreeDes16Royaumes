...
public class BronzeSwordItem extends ContreeDesRoyaumesModElements.ModElement {
	@ObjectHolder("contree_des_royaumes:bronze_sword")
	public static final Item block = null;
	public BronzeSwordItem(ContreeDesRoyaumesModElements instance) {
		super(instance, 9);
	}
