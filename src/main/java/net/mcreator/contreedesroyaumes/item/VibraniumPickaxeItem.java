...
public class VibraniumPickaxeItem extends ContreeDesRoyaumesModElements.ModElement {
	@ObjectHolder("contree_des_royaumes:vibranium_pickaxe")
	public static final Item block = null;
	public VibraniumPickaxeItem(ContreeDesRoyaumesModElements instance) {
		super(instance, 28);
	}
