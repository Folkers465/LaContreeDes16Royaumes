...
public class VibraniumAxeItem extends ContreeDesRoyaumesModElements.ModElement {
	@ObjectHolder("contree_des_royaumes:vibranium_axe")
	public static final Item block = null;
	public VibraniumAxeItem(ContreeDesRoyaumesModElements instance) {
		super(instance, 29);
	}
