...
public class BronzeShovelItem extends ContreeDesRoyaumesModElements.ModElement {
	@ObjectHolder("contree_des_royaumes:bronze_shovel")
	public static final Item block = null;
	public BronzeShovelItem(ContreeDesRoyaumesModElements instance) {
		super(instance, 10);
	}
