...
public class VibraniumSwordItem extends ContreeDesRoyaumesModElements.ModElement {
	@ObjectHolder("contree_des_royaumes:vibranium_sword")
	public static final Item block = null;
	public VibraniumSwordItem(ContreeDesRoyaumesModElements instance) {
		super(instance, 30);
	}
