...
public class BronzePickaxeItem extends ContreeDesRoyaumesModElements.ModElement {
	@ObjectHolder("contree_des_royaumes:bronze_pickaxe")
	public static final Item block = null;
	public BronzePickaxeItem(ContreeDesRoyaumesModElements instance) {
		super(instance, 7);
	}
