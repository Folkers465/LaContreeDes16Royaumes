...
public class VibraniumBlockBlock extends ContreeDesRoyaumesModElements.ModElement {
	@ObjectHolder("contree_des_royaumes:vibranium_block")
	public static final Block block = null;
	public VibraniumBlockBlock(ContreeDesRoyaumesModElements instance) {
		super(instance, 24);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("vibranium_block");
		}
