...
import net.mcreator.contreedesroyaumes.item.VibraniumItem;
...
public class VibraniumOreBlock extends ContreeDesRoyaumesModElements.ModElement {
	@ObjectHolder("contree_des_royaumes:vibranium_ore")
	public static final Block block = null;
	public VibraniumOreBlock(ContreeDesRoyaumesModElements instance) {
		super(instance, 23);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(VibraniumItem.block, (int) (1)));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("contree_des_royaumes:vibranium_ore_match"),
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("contree_des_royaumes:vibranium_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
