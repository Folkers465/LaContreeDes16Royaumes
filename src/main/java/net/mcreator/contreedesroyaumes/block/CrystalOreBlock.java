...
public class CrystalOreBlock extends ContreeDesRoyaumesModElements.ModElement {
	@ObjectHolder("contree_des_royaumes:crystal_ore")
	public static final Block block = null;
	public CrystalOreBlock(ContreeDesRoyaumesModElements instance) {
		super(instance, 86);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("contree_des_royaumes:crystal_ore_match"),
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("contree_des_royaumes:crystal_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
