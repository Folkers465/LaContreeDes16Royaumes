...
public class SaphirOreBlock extends ContreeDesRoyaumesModElements.ModElement {
	@ObjectHolder("contree_des_royaumes:saphir_ore")
	public static final Block block = null;
	public SaphirOreBlock(ContreeDesRoyaumesModElements instance) {
		super(instance, 65);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("contree_des_royaumes:saphir_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("saphir_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("contree_des_royaumes:saphir_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
