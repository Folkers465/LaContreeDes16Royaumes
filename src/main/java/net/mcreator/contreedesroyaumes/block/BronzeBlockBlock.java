...
public class BronzeBlockBlock extends ContreeDesRoyaumesModElements.ModElement {
	@ObjectHolder("contree_des_royaumes:bronze_block")
	public static final Block block = null;
	public BronzeBlockBlock(ContreeDesRoyaumesModElements instance) {
		super(instance, 3);
	}
