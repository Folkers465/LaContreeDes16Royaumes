...
public class CrystalBlockBlock extends ContreeDesRoyaumesModElements.ModElement {
	@ObjectHolder("contree_des_royaumes:crystal_block")
	public static final Block block = null;
	public CrystalBlockBlock(ContreeDesRoyaumesModElements instance) {
		super(instance, 87);
	}
