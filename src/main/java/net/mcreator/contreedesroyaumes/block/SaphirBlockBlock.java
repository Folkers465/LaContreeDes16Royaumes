...
public class SaphirBlockBlock extends ContreeDesRoyaumesModElements.ModElement {
	@ObjectHolder("contree_des_royaumes:saphir_block")
	public static final Block block = null;
	public SaphirBlockBlock(ContreeDesRoyaumesModElements instance) {
		super(instance, 66);
	}
